...
| Measure | Count |
| --- | ---: |
| Tracked 1.06a function candidates | 4,012 |
| Origin/boundary review pending | 1,305 |
| Confirmed authored functions | 1,414 |
| Confirmed authored code bytes | 2,075,924 |
| Classified exclusions | 1,293 |
| Source-present authored mappings | 1,327 |
| Canonical exact functions | 1,285 |
| Canonical exact authored bytes | 215,745 |

...
The SHA-pinned VC8 SP1 archive replay now strictly reproduces 101 runtime
functions and 15,904 bytes. The initial breadth wave contributes 74 functions
...
four functions and 994 bytes. Ambiguous identical-body symbols are excluded. Reproduction

...
- `scripts/function-origins.py --check`: target-backed replay of generated authored/excluded origin census rules (requires canonical target plus SHA-pinned VC8 and Xiph SDK archives).

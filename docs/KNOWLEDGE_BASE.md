...
- The accepted 1.06a authored set contains 278 functions / 49,343 bytes in 142
  VC8 match units. The newest whole-corpus retained-source/lifecycle wave added 178
  functions / 35,856 bytes beyond the previous 100-function checkpoint. Candidate
...
- Original translation-unit partition and which classes/functions underwent
  LTCG transformation.
- Accepted boundaries and authored/library origins for the remaining 3,031

...
- The accepted 1.06a authored set contains 272 functions / 48,958 bytes in 140
  VC8 match units. The newest whole-corpus retained-source/lifecycle wave added 172
  functions / 35,471 bytes beyond the previous 100-function checkpoint. Candidate
...
- Original translation-unit partition and which classes/functions underwent
  LTCG transformation.
- Accepted boundaries and authored/library origins for the remaining 3,045

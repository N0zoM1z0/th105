...
- The accepted 1.06a authored set contains 259 functions / 34,865 bytes in 127
  VC8 match units. The newest whole-corpus retained-source/lifecycle wave added 159
  functions / 21,378 bytes beyond the previous 100-function checkpoint. Candidate
...
- Original translation-unit partition and which classes/functions underwent
  LTCG transformation.
- Accepted boundaries and authored/library origins for the remaining 3,060

...
- The accepted 1.06a authored set contains 270 functions / 45,993 bytes in 138
  VC8 match units. The newest whole-corpus retained-source/lifecycle wave added 170
  functions / 32,506 bytes beyond the previous 100-function checkpoint. Candidate
...
- Character event bridges are now a target-backed recovery family rather than header-only declarations. Twelve are canonical exact: Alice `0x0050ED00` (1075), Reimu `0x004A3220` (1061), Marisa `0x004CA980` (865), Sakuya `0x004E9B40` (843), Patchouli `0x0052FDB0` (904), Youmu `0x00544BF0` (969), Remilia `0x0055D380` (1043), Yuyuko `0x0057AB90` (986), Suika `0x005BF7D0` (1203), Udonge `0x005E1C50` (959), Komachi `0x00601D20` (1118), and Aya `0x006203B0` (1177). Each current body was independently reconstructed around its character-specific event constants, access widths, effect/action ids, helper calls, and virtual slots before canonical comparison; historical same-size evidence was only a location seed. The historical event-case census remains only a seed. Yukari, Iku, and Tenshi are not yet exact.
...
- Original translation-unit partition and which classes/functions underwent
  LTCG transformation.
- Accepted boundaries and authored/library origins for the remaining 3,047

...
- The IDA inventory has 4,001 provisional candidates. Current reviewed state is
  100 authored functions, 480 classified exclusions, and 3,421 still awaiting origin/boundary review.
...
The 95% authored-function and authored-byte goals cannot be reported yet: 3,421

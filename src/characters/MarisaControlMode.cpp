...
struct MarisaControlPeerView {
    unsigned char unknown_000[0x174];
    short value_174;
};

class MarisaControlModeView {
public:
...
typedef char MarisaControl_action_offset[
    offsetof(MarisaControlModeView, action_13c) == 0x13c ? 1 : -1];
typedef char MarisaControl_sequence_offset[
    offsetof(MarisaControlModeView, sequence_controller_55c) == 0x55c ? 1 : -1];
typedef char MarisaControl_policy_offset[
    offsetof(MarisaControlModeView, policy_counter_764) == 0x764 ? 1 : -1];

void MarisaControlModeView::update_control_mode()
{
    --policy_counter_768;
    command_flags_724 = 0;
    command_flags_728 = 0;
    ...
    case 2:
    case 3: {
        short state = policy_counter_76a;
        if (state == 0) {
        ...
        state = policy_counter_76a;
        if (state == 3 && other_fighter_170->value_174 > 0 &&
            (action_13c == 700 || action_13c == 0)) {
            facing_104 = x_ec <= 640.0f ? 1 : -1;
            policy_x_780 = static_cast<float>(
                static_cast<unsigned int>(selector_random_roll(10))) + 10.0f;
            policy_y_784 = 12.5f;
            policy_scale_788 = 0.4f;
            set_action(702);
            policy_counter_76a = 2;
        }
        if (state == 4 && other_fighter_170->value_174 > 0 &&
            (action_13c == 700 || action_13c == 0)) {
            set_action(711);
            policy_counter_76a = 3;
        }
    ...
    case 7: {
        ...
        if (state == 1 && (action_13c == 700 || action_13c == 0)) {
            face_opponent_and_flip_horizontal_velocity();
            set_action(720);
            policy_counter_76a = 2;
            return;
        }
        if (state == 2 && action_13c == 720 && sequence_13e == 4) {
            policy_counter_76a = 3;
            return;
        }
        if (state == 3 && action_13c == 720 && sequence_13e == 4 &&
            policy_counter_768 <= 0) {
            int next = static_cast<int>(
                static_cast<float>(
                    static_cast<unsigned int>(selector_random_roll(3))) + 4.0);
            policy_counter_76a = static_cast<short>(next);
            set_sequence(next + 1);
            if (policy_counter_76a == 4)
                policy_counter_768 = 80;
            if (policy_counter_76a == 5)
                policy_counter_768 = 150;
            if (policy_counter_76a == 6)
                policy_counter_768 = 240;
        }
        if (policy_counter_76a == 4 && action_13c == 720 && sequence_13e == 5 &&
            policy_counter_768 <= 0) {
            policy_counter_76a = 7;
            set_sequence(4);
            policy_counter_768 = 80;
        }
        if (policy_counter_76a == 5 && action_13c == 720 && sequence_13e == 6 &&
            policy_counter_768 <= 0) {
            policy_counter_76a = 7;
            set_sequence(4);
            policy_counter_768 = 80;
        }
        if (policy_counter_76a == 6 && action_13c == 720 && sequence_13e == 7 &&
            policy_counter_768 <= 0) {
            policy_counter_76a = 7;
            set_sequence(4);
            policy_counter_768 = 80;
        }
        if (policy_counter_76a == 7 && action_13c == 720 && sequence_13e == 4 &&
            policy_counter_768 <= 0) {
            policy_counter_76a = 3;
            set_sequence(2);
            policy_counter_768 = 30;
        }
        return;
    }
    ...
    case 11: {
        ...
        if (state == 2) {
            if (other_fighter_170->value_174 <= 0) {
                policy_counter_76a = 1;
            } else if (action_13c == 700 || action_13c == 0) {
                face_opponent_and_flip_horizontal_velocity();
                if (static_cast<unsigned int>(selector_random_roll(100)) < 50)
                    set_action(730);
                else
        ...
        if (state == 3 && other_fighter_170->value_174 > 0 &&
            ...
            facing_104 = x_ec <= 640.0f ? 1 : -1;
            policy_x_780 = static_cast<float>(
                static_cast<unsigned int>(selector_random_roll(5))) + 5.0f;
            policy_y_784 = 12.5f;
            policy_scale_788 = 0.4f;
            set_action(702);
            policy_counter_76a = 2;

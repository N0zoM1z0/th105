...
// Narrow 1.06a source view for Komachi's event bridge. Only fields, access widths,
...
class KomachiEventView {
public:
    virtual ~KomachiEventView();
...
public:
    ...
    KomachiEventView *other_fighter_170;
...
typedef char KomachiEventView_state_13c_offset[
    offsetof(KomachiEventView, state_13c) == 0x13c ? 1 : -1];
typedef char KomachiEventView_other_offset[
    offsetof(KomachiEventView, other_fighter_170) == 0x170 ? 1 : -1];
typedef char KomachiEventView_event_counter_offset[
    offsetof(KomachiEventView, event_counter_730) == 0x730 ? 1 : -1];
typedef char KomachiEventView_event_flag_offset[
    offsetof(KomachiEventView, event_flag_759) == 0x759 ? 1 : -1];

unsigned char KomachiEventView::handle_event_bridge(int event_code)
{
    switch (event_code) {
    case 1:
        x_ec = 100.0f;
    ...
    case 103:
        event_subobject_130.trigger_global_effect(12);
        event_flag_759 = 1;
        event_value_75c = 0;
        event_value_760 = 180;
        return false;
    ...
    case 105: {
        KomachiEventView *const other = other_fighter_170;
        y_f0 = 960.0f;
        x_ec = other->x_ec +

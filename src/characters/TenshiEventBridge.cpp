...
// Narrow 1.06a source view for Tenshi's event bridge. Current target event
// payloads and unused-this member-call liveness define the recovered ABI.
...
class TenshiEventView {
public:
    virtual ~TenshiEventView();
    ...
    int set_shared_scalar(float value);
    ...
    TenshiEventView *other_fighter_170;
    ...
    int event_value_75c;
    int event_value_760;
    unsigned char unknown_764[0x2a];
    short word_78e;
};

typedef char Tenshi_state_offset[offsetof(TenshiEventView, state_13c) == 0x13c ? 1 : -1];
typedef char Tenshi_counter_offset[offsetof(TenshiEventView, event_counter_730) == 0x730 ? 1 : -1];
typedef char Tenshi_word_78e_offset[offsetof(TenshiEventView, word_78e) == 0x78e ? 1 : -1];

unsigned char TenshiEventView::handle_event_bridge(int event_code)
{
    switch (event_code) {
    case 1:
        x_ec = 100.0f;
    ...
    case 103:
        event_subobject_130.trigger_global_effect(14);
        event_flag_759 = 1;
        event_value_75c = 0;
        event_value_760 = 180;
        return false;
    case 105: {
        TenshiEventView *const other = other_fighter_170;
        y_f0 = 960.0f;
    ...
    case 131:
        ...
        set_shared_second_target(1, static_cast<float>(event_counter_730));
        g_shared_event_state.synchronize_targets();
        return --event_counter_730 > 0;
    case 132:
        set_action(788);
        return false;
    case 133:
        set_shared_scalar(6.0f);
        return false;
    case 134:
        set_action(780);
        x_ec = 800.0f;

...
// Narrow 1.06a source view for Marisa's event bridge. Only current-target
...
class MarisaEventView {
public:
    virtual ~MarisaEventView();
...
typedef char MarisaEventView_state_13c_offset[
    offsetof(MarisaEventView, state_13c) == 0x13c ? 1 : -1];
typedef char MarisaEventView_other_offset[
    offsetof(MarisaEventView, other_fighter_170) == 0x170 ? 1 : -1];
typedef char MarisaEventView_event_counter_offset[
    offsetof(MarisaEventView, event_counter_730) == 0x730 ? 1 : -1];
typedef char MarisaEventView_event_flag_offset[
    offsetof(MarisaEventView, event_flag_759) == 0x759 ? 1 : -1];

unsigned char MarisaEventView::handle_event_bridge(int event_code)
{
    switch (event_code) {
    case 1:
    ...
    case 105: {
        MarisaEventView *const other = other_fighter_170;
        y_f0 = 960.0f;
        x_ec = other->x_ec +

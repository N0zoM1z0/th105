...
struct YoumuControlPeerView {
    unsigned char unknown_000[0x174];
    short value_174;
};

class YoumuControlModeView {
public:
...
public:
    ...
    YoumuControlPeerView *other_fighter_170;
...
typedef char YoumuControl_action_offset[
    offsetof(YoumuControlModeView, action_13c) == 0x13c ? 1 : -1];
typedef char YoumuControl_sequence_offset[
    offsetof(YoumuControlModeView, sequence_controller_55c) == 0x55c ? 1 : -1];
typedef char YoumuControl_control_offset[
    offsetof(YoumuControlModeView, control_6b4) == 0x6b4 ? 1 : -1];
typedef char YoumuControl_policy_offset[
    offsetof(YoumuControlModeView, policy_counter_764) == 0x764 ? 1 : -1];
typedef char YoumuControl_derived_offset[
    offsetof(YoumuControlModeView, policy_x_780) == 0x780 ? 1 : -1];

void YoumuControlModeView::update_control_mode()
{
    --policy_counter_768;

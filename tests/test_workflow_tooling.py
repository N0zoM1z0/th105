...
class WorkflowToolingTests(unittest.TestCase):
    ...
    def test_corrected_inventory_tracks_only_current_target_progress(self) -> None:
        ...
        self.assertEqual(len(matching), 54)
    ...
    def test_progress_reports_current_exact_baseline(self) -> None:
        ...
        self.assertIn("Confirmed authored functions | 54", markdown)
        self.assertIn("Canonical exact functions | 54", markdown)
        self.assertIn("Canonical exact authored bytes | 4,373", markdown)
        self.assertIn(
